                    ...
                    <div className='grid grid-cols-2 py-16'>
                        <div className=' py-6 flex'>
                            ...
                            <div className='px-3'>
                                ...
                                <p className='text-[#6D737A] font-semibold'>Instructor</p>
                            </div>
                        </div>
                        ...
                        <div className=' py-6 flex'>
                            ...
                            <div className='px-3'>
                                ...
                                <p className='text-[#6D737A] font-semibold'>Videos</p>
                            </div>
                        </div>
                        ...
                        <div className=' py-6 flex'>
                            ...
                            <div className='px-3'>
                                ...
                                <p className='text-[#6D737A] font-semibold'>Students</p>
                            </div>
                        </div>
                        ...
                        <div className=' py-6 flex'>
                            ...
                            <div className='px-3'>
                                ...
                                <p className='text-[#6D737A] font-semibold'>User's</p>
                            </div>
                        </div>
