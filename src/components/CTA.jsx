...
const CTA = () => {
  return (
    <div className=' w-full bg-[#E9F8F3] py-24 '>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 gap-8 max-w-[600] items-center'>
            ...
            <div>
               ...
               <button className='max-[780px]:w-full my-4 px-8 py-5 rounded-md glow-on-hover bg-[#20B486] text-white font-bold'>Sign Up For Free</button>
